...
extern void *internal_memset(void *s, int c, size_t n);
  ...
  if (!PREACTION(m)) {
    ...
    if (newp != 0) {
      ...
      if (newmem != 0) {
        ...
        internal_memcpy(newmem, oldmem, (oc < bytes)? oc : bytes);
...
static void** ialloc(mstate m,
  ...
  */
  ...
  if (opts & 0x2) {       /* optionally clear the elements */
    internal_memset((size_t*)mem, 0, remainder_size - SIZE_T_SIZE - array_size);
  }
